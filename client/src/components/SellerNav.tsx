...
import { faHome, faSearch, faUser, faPlusCircle, faCommentDots } from "@fortawesome/free-solid-svg-icons";
...
export default function SellerNav(){
    return (
        <div className="fixed bottom-0 bg-white py-4 flex items-center px-6 gap-12 rounded-2xl shadow-[0_-2px_4px_rgba(0,0,0,0.2)]">
            ...
            <span className="text-primary text-2xl"><FontAwesomeIcon icon={faPlusCircle}/></span>
